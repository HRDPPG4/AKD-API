...
public class MainClass {
	public static void main(String[] args) throws GeneralSecurityException, IOException ,HttpClientErrorException{
        ...
        GoogleCredential googleCredential = new GoogleCredential.Builder()
        					...
        					.setServiceAccountId("all-khmer-docs@akd-api.iam.gserviceaccount.com")
        					.setServiceAccountScopes(scopes)
        					.setServiceAccountPrivateKeyFromP12File(new File("AKD-API-3512d7454018.p12"))
        					.build();
		...
		Resource resource = new FileSystemResource("D:\\KSHRD\\ALL KHMER DOCS\\Project\\Github\\Documents\\Chapter 04-Managing Packages and Process.pptx");
		...
		DriveFile.Builder metaData = DriveFile.builder()
										.setTitle(fileName)
										.setDescription("This file is created by Chivorn")
										.setParents("0B4RhbtI4DXY_QWVOWkFiSTlRY1E")
										.setViewed(true)
										.setRestricted(false);				
